...
const ProjectCards = ({ project, index, isDarkMode }) => {
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl overflow-hidden border cursor-default select-none ransition-all duration-500 ${
          isDarkMode
        ...
        <div className="relative overflow-hidden">
          ...
          >
            <motion.a
              ...
              target="_blank"
              className="hover:bg-blue-600 text-white px-4 py-2 rounded-full flex items-center space-x-2 text-sm font-medium transition-colors"
            >
