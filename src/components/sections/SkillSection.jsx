...
>
  ...
  <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
    ...
    >
      ...
      >
        Skills & <span className="text-blue-500 font-medium">Tools</span>
      </motion.h2>
      ...
      >
        Tools and skills that help me build better apps and grow along the way.
      </motion.p>
    </motion.div>
    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-8">
        <h3 className="text-xl font-medium mb-4">
          Technologies I Build and Learn With
        </h3>
      </motion.div>
      ...
      >
        {TECH_STACK.map((tech) => (
          <motion.span
            ...
            className={`px-4 py-2 text-sm rounded-full border select-none transition-all duration-100 ${
              isDarkMode
    ...
    <motion.div
      ...
      animate={isInView ? "visible" : "hidden"}
      variants={containerVariants}
      className="mt-20 grid grid-cols-2 select-none md:grid-cols-3 gap-6 justify-items-center"
    >
      {STATS.map((stat) => (
        <motion.div
          key={stat.label}
