...
import Meowth from "../../assets/images/meowth2.png";
      ...
      <div className="relative z-10 px-6 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <div
                className={`h-px w-[138px] ${
                  isDarkMode ? "bg-gray-700" : "bg-gray-300"
                }`}
              />
              <div
                className={`h-px w-[138px] -ml-px  ${
                  isDarkMode ? "bg-gray-700" : "bg-gray-300"
                }`}
              />
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              >
                © {new Date().getFullYear()} Frenatoval. All rights reserved.
              </p>
              <p
                className={`text-sm ${
              ...
              >
                Built entirely by Valih Frenato with React & Framer Motion
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                onClick={scrollToTop}
                className={`inline-flex items-center cursor-pointer space-x-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  isDarkMode
